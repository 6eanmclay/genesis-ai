...
export const CONFIG: ConfigEntry[] = [
  ...
  { name: "PLATFORM_ADMIN_EMAILS", group: "ops", requirement: "production", secret: false,
    purpose: "Who may reach the operator surfaces, and whose own store Genesis does not meter.",
    absence: "Fails CLOSED — nobody is a platform administrator, /admin is unreachable, and the platform's own store is charged Growth Points like any customer." },
