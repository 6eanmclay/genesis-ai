...
// IMPORTED FROM lib/, NOT FROM THE SERVER-ACTION MODULE. The first version of
// this file imported these from app/dashboard/ai-actions.ts, which meant
// exporting them from a "use server" module — and that broke `next build` for
// two commits while every other gate stayed green. The declarations moved
// byte-exact to their own module; nothing here measures a copy.
